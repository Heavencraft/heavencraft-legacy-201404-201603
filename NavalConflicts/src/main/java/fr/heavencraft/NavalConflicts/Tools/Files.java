...
public class Files {
	// Set up all the needed things for files
		...
		public static FileConfiguration getConfig() {
			return NavalConflicts.getInstance().getConfig();
		}

		public static void saveConfig() {
			NavalConflicts.getInstance().saveConfig();
		}

		public static void reloadConfig() {
			NavalConflicts.getInstance().reloadConfig();
		}
		...
		public static void reloadClasses() {
			if (classesFile == null)
				classesFile = new File(
						Bukkit.getPluginManager().getPlugin("NavalConflicts").getDataFolder(),
						"Classes.yml");
			classes = YamlConfiguration.loadConfiguration(classesFile);
			// Look for defaults in the jar
			InputStream defConfigStream = Bukkit.getPluginManager().getPlugin("NavalConflicts").getResource("Classes.yml");
		...
		public static void reloadArenas() {
			...
			// Look for defaults in the jar
			InputStream defConfigStream = Bukkit.getPluginManager().getPlugin("NavalConflicts").getResource("Arenas.yml");
			if (defConfigStream != null)
			{
				YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
		...
		public static void reloadGrenades() {
			...
			// Look for defaults in the jar
			InputStream defConfigStream = Bukkit.getPluginManager().getPlugin("NavalConflicts").getResource("Grenades.yml");
			if (defConfigStream != null)
			{
				YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
		...
		public static void reloadShop() {
			...
			// Look for defaults in the jar
			InputStream defConfigStream = Bukkit.getPluginManager().getPlugin("NavalConflicts").getResource("Shop.yml");
			if (defConfigStream != null)
			{
				YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
		...
		public static void reloadMessages() {
			...
			// Look for defaults in the jar
			InputStream defConfigStream = Bukkit.getPluginManager().getPlugin("NavalConflicts").getResource("Messages.yml");
			if (defConfigStream != null)
			{
				YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
		...
		public static void reloadPlayers() {
			...
			// Look for defaults in the jar
			InputStream defConfigStream = Bukkit.getPluginManager().getPlugin("NavalConflicts").getResource("Players.yml");
			if (defConfigStream != null)
			{
				YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
		...
		public static void reloadSigns() {
			...
			// Look for defaults in the jar
			InputStream defConfigStream = Bukkit.getPluginManager().getPlugin("NavalConflicts").getResource("Signs.yml");
			if (defConfigStream != null)
			{
				YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
