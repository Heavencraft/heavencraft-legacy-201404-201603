...
public class NoentitiesCommand extends HeavenCommand
{
	public NoentitiesCommand()
	{
		super("noentities", "heavencraft.commands.noentities");
	}
	...
	private static void printWarning(Chunk chunk, CommandSender sender)
	{
		...
		ChatUtil.sendMessage(sender, "Chunk %1$s %2$s %3$s", chunk.getWorld().getName(), chunk.getX(), chunk.getZ());
