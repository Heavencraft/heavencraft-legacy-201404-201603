...
public class NoelFiles {
	...
	// Set up all the needed things for files
		...
		public static void reloadPlayers() {
			if (playersFile == null)
				playersFile = new File(Bukkit.getPluginManager().getPlugin("HeavenNoel").getDataFolder(), "Players.yml");
			Players = YamlConfiguration.loadConfiguration(playersFile);		
			// Look for defaults in the jar
			InputStream defConfigStream = Bukkit.getPluginManager().getPlugin("HeavenNoel").getResource("Players.yml");
