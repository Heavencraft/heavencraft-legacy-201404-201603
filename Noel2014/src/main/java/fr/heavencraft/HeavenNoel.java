...
public class HeavenNoel extends JavaPlugin {
	...
	private static HeavenNoel _instance;
	...
	public void onEnable()
	{
		super.onEnable();
		_instance = this;
		NoelFiles.getPlayers().options().copyDefaults(true);
		NoelFiles.saveAll();
	...
	public static HeavenNoel getInstance()
	{
		return _instance;
	}
