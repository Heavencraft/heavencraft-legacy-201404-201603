...
public class AddOwnerSubCommand implements SubCommand
{
	@Override
	...
	public void execute(CommandSender sender, String[] args) throws HeavenException
	{
		...
		HeavenGuard.getRegionProvider().getRegionByName(name).addMember(owner.getUniqueId(), true);
	...
	{
		ChatUtil.sendMessage(sender, "/{region} addowner <protection> <propriétaire>");
	}
}