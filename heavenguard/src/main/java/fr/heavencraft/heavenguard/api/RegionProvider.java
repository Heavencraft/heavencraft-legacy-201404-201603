...
{
	void createRegion(String name, String world, int minX, int minY, int minZ, int maxX, int maxY, int maxZ) throws HeavenException;

	Region getRegionById(int id) throws HeavenException;
